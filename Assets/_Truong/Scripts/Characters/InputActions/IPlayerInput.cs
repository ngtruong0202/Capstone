...
//     version 1.7.0
//     from Assets/_Truong/Scripts/Characters/InputActions/IPlayerInput.inputactions
//
...
public partial class @IPlayerInput: IInputActionCollection2, IDisposable
{
    ...
    {
        private @IPlayerInput m_Wrapper;
        public IPlayerActions(@IPlayerInput wrapper) { m_Wrapper = wrapper; }
